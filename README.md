...
Note the change in behaviour from jOOQ 3.8.7 to 3.9.0 when &lt;outputSchemaToDefault&gt; is true, where ```TableField<TestRecord, TestStatus>``` becomes ```TableField<TestRecord, Object>```
